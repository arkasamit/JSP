...
const copyArray = original.slice(0);
copyArray[0] = 99;
...
console.log(original);
  ...
  for (let i = 0; i < studentArray.length; i++) {
    ...
    console.log(`${studentArray[i].name} scored ${studentArray[i].marks}`);
...
// For uderstand how declace in spilce method is 
// Replace first element of second row
// twoDarray[1].splice(0, 1, 99);